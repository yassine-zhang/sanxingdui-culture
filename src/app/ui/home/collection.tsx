...
const collections = [
  ...
  },
  {
    ...
    title: "商青铜人头像",
    description:
      "这件青铜人头像是三星堆出土的典型人像艺术代表，头戴条状纹理的高冠，面部特征鲜明。其扁平的脸部、凸起的眉骨、细长的眼睛和夸张的耳朵，体现了三星堆文化独特的艺术风格。头像的耳部有明显的装饰设计，颧骨高耸，嘴部呈直线状，整体呈现出威严而神秘的感觉。这类青铜人头像可能代表了当时社会的祭祀对象或统治者，反映了古蜀人特殊的精神世界和审美观念。从制作工艺来看，采用了失蜡法铸造，展现了商代青铜器高超的冶炼和铸造技术。",
    image: "/home/item05.png",
    details: {
      era: "中国历史学年代,商(前1600~前1046)",
      level: "一级",
      material: "青铜器",
      dimensions: "高28.4，宽12.6，厚8.7厘米",
    },
  },
  {
    id: 6,
    title: "商代金面具",
    description:
      "商代金面具采用金属镶嵌工艺，表面有明显的金色光泽，造型奇特，部分区域已经有损坏。从其形态来看，它具有高度的艺术表现力，且可能与祭祀仪式或宗教信仰相关。金面具通常用于祭祀活动中，象征神灵的力量与神秘。",
    image: "/home/item06.png",
    details: {
      era: "中国历史学年代,商(前1600~前1046)",
      level: "一级",
      material: "金",
      dimensions: "长35，宽15，高20厘米",
    },
  },
  {
    id: 7,
    title: "商代青铜器兽形器",
    description:
      "这件展品是一个青铜器，雕刻精细，细节丰富。青铜器的造型呈现出神话中的动物形象，可能与古代宗教仪式或王权的象征相关。其表面有许多复杂的纹路和图案，显示出三星堆文化中对神灵和动物的崇拜。",
    image: "/home/item07.png",
    details: {
      era: "中国历史学年代,商(前1600~前1046)",
      level: "一级",
      material: "青铜器",
      dimensions: "长25，宽10，高15厘米",
    },
  },
  {
    id: 8,
    title: "商代玉器",
    description:
      "这是一件精美的玉器制品，表面呈现出独特的纹理，体现了当时社会对美学的追求。玉器是中国古代重要的文化象征之一，常常与贵族阶层和宗教仪式紧密联系。此件玉器的工艺体现了三星堆文化中高度发展的玉雕技艺。",
    image: "/home/item08.png",
    details: {
      era: "中国历史学年代,商(前1600~前1046)",
      level: "一级",
      material: "玉",
      dimensions: "高12，宽8，厚6厘米",
    },
  },
];
